...
def process(job):
    ...
    try:
        ...
        if "bypass_auto_pitch" in job_input and job_input["bypass_auto_pitch"] is True:
        ...
        return {
            ...
            "auto_pitch_correction_bypassed": job_input["bypass_auto_pitch"] if "bypass_auto_pitch" in job_input else False,
            "pitch_correction_semitones": pitch_correction_semitones,
            "model_f0m": job_input["model_f0m"] if "model_f0m" in job_input else 0,
