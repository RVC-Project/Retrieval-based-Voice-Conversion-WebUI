...
class SynthesizerTrnMs256NSFsid(nn.Module):
    ...
    @torch.jit.ignore
    def forward(
        self, phone:torch.Tensor, phone_lengths:torch.Tensor, \
            pitch:torch.Tensor,pitchf:torch.Tensor, y:torch.Tensor,\
            y_lengths:torch.Tensor, ds:Optional[torch.Tensor]=None
    ):  # 这里ds是id，[bs,1]
